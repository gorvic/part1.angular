    ...
    function AdvertiseDetailController($q, $location, $stateParams, $window,
        ...
        function getCategories() {
            return dataservice.getCategories().then(function (data) {
                ...
                ////добавим в каждую категорию по полю parent_name
                //vm.categories = vm.categories.map(function(obj) {
                //    return angular.extend(obj, parent_name);
                //});
                //
        ...
        function getRequestedAdvertise() {
            ...
            return dataservice.getAdvertise(val).then(function (data) {
                    vm.advertise = data;
                    return vm.advertise;
                })
                .catch(function (error) {
                    logger.error('Error while getting advertise id = ' + val + '; ' + error);
                    gotoAdvertises();
                });
        }
